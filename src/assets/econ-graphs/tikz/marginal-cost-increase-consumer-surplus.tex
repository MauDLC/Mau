...
\path[fill=cs,opacity=.23] (axis cs:0,9) -- (axis cs:0,5.5) -- (axis cs:5,5.5) -- cycle;
\path[fill=cs,opacity=.13] (axis cs:0,9) -- (axis cs:0,6.2) -- (axis cs:4,6.2) -- cycle;
...
\addplot[domain=.5:9.4,samples=2,very thick,mc] {2.2} node[pos=.86,above,font=\small] {$CMg_1$};
\addplot[domain=.5:9.4,samples=2,very thick,mc,dashed] {3.4} node[pos=.86,above,font=\small] {$CMg_2$};
...
\node[font=\small] at (axis cs:3,8.2) {EC disminuye};
\end{axis}
\end{tikzpicture}
\end{document}
